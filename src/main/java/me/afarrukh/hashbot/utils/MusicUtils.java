...
public class MusicUtils {
    ...
    public static void play(MessageReceivedEvent evt, GuildMusicManager musicManager, AudioTrack track, boolean playTop) {
        ...
        if (playTop) {
            evt.getChannel().sendMessageEmbeds(EmbedUtils.getQueuedTopEmbed(musicManager, track, evt)).queue();
        } else
            evt.getChannel().sendMessageEmbeds(EmbedUtils.getQueuedEmbed(musicManager, track, evt)).queue();
    }

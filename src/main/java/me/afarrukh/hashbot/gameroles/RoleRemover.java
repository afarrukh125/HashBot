...
public class RoleRemover implements RoleGUI {
    ...
    public RoleRemover(MessageReceivedEvent evt) {
        ...
        message = evt.getChannel().sendMessageEmbeds(EmbedUtils.getUserGameRoleListEmbed(this, page)).complete();
    ...
    private void chooseRole(MessageReactionAddEvent evt) {
        ...
        switch (reactionName) {
            ...
            case e_left:
                if (page <= 1)
                    return;
                page--;
                message.editMessageEmbeds(EmbedUtils.getUserGameRoleListEmbed(this, page)).queue();
        ...
        message.editMessageEmbeds(EmbedUtils.confirmRemoveRole(this, desiredRole)).queue();
    }
    ...
    private void confirmRole(MessageReactionAddEvent evt) {
        ...
        switch (reactionName) {
            ...
            case confirm:
                ...
                if (desiredRole == null) {
                    message.editMessageEmbeds(EmbedUtils.getNullRoleEmbed(this)).queue();
                    return;
                }
                try {
                    message.editMessageEmbeds(EmbedUtils.addRoleRemovedEmbed(this, desiredRole)).queue();
